...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                                <span><img alt="image" width="180" height="61" src="plug-in/login/images/btzoon.png" /></span>
                    </div>
                    <div class="logo-element">集装箱
                    </div>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="欢迎使用集装箱车队管理系统 …" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
        ...
        <div class="footer" style="border-top:none;">
            <div class="pull-right">&copy; <a href="http://www.btzoon.com/" target="_blank">柏田科技</a>
            </div>
        </div>        
    </div>
    <!--右侧部分结束-->
