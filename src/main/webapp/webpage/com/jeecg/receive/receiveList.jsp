...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="receiveList" checkbox="true" fitColumns="true" title="应收账单" actionUrl="receiveController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="receiveController.do?doDel&id={id}"  urlclass="ace_button" urlfont="fa-trash-o"/>--%>
   <t:dgToolBar title="录入" icon="icon-add" url="receiveController.do?goAdd" funname="add" width="100%" height="100%"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="receiveController.do?goUpdate" funname="update" width="100%" height="100%"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="receiveController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="receiveController.do?goUpdate" funname="detail" width="100%" height="100%"></t:dgToolBar>
 ...
 <script src = "webpage/com/jeecg/receive/receiveList.js"></script>		
 <script type="text/javascript">
 
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'receiveController.do?upload', "receiveList");
}

//导出
function ExportXls() {
	JeecgExcelExport("receiveController.do?exportXls","receiveList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("receiveController.do?exportXlsByT","receiveList");
}
 </script>