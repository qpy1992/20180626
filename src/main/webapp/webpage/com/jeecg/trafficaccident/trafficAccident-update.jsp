...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="trafficAccidentController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="fbillno" name="fbillno" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${trafficAccidentPage.fbillno}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="fcarno" name="fcarno" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${trafficAccidentPage.fcarno}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="fname" name="fname" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${trafficAccidentPage.fname}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									   <input id="fchuxianTime" name="fchuxianTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  ignore="ignore"  value='<fmt:formatDate value='${trafficAccidentPage.fchuxianTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" colspan="3">
						    <input id="faddress" name="faddress" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${trafficAccidentPage.faddress}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value" colspan="3">
						  	 	<textarea id="fnote" style="width:600px;" class="inputxt" rows="6" name="fnote"  ignore="ignore" >${trafficAccidentPage.fnote}</textarea>
							<span class="Validform_checktip"></span>
