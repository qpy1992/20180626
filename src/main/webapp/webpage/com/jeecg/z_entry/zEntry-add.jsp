...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zEntryController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="zLs" name="zLs" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value">
		     	 <input id="zPeople" name="zPeople" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
	...
	<tbody id="add_zEntrydetail_table_template">
		<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="zEntrydetailList[#index#].zWldm" maxlength="32" onclick="popupClick(this,'fWldm,fwlmc,fggxh,fdw,fjj','zWldm,zWlmc,zGgxh,zDw,zJprice','wuliao')" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
				  ...
				  <td align="left">
					  	<input name="zEntrydetailList[#index#].zCgdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" maxlength="32" type="text" class="easyui-datebox datebox-f combo-f"  comboname="date"  style="width:120px;"  ignore="ignore" />
