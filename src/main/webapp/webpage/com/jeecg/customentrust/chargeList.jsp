...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="chargeList" checkbox="true" pagination="true" fitColumns="true" title="委托单位:${fentrustunit} 委托单号:${fbillno} 提单号:${fblno}" actionUrl="customEntrustController.do?datagrid1&cid=${cid}" idField="id" fit="true" queryMode="group">
