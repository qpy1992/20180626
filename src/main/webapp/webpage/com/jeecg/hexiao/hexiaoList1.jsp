...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hexiaoList" checkbox="false" pagination="true" fitColumns="true" title="费用核销" actionUrl="hexiaoController.do?datagrid2" idField="id" fit="true" queryMode="group">
