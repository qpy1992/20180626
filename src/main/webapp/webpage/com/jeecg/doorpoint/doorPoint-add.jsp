...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="doorPointController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="fdpCode" name="fdpCode" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
		...
		<tr>
			...
			<td class="value">
		     	 <input id="fdpName" name="fdpName" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
            ...
            <td class="value" colspan="3">
                ...
                <input id="dizhi" name="dizhi" type="text" style=" width: 500px" class="inputxt"  ignore="ignore" />
                <span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
		     	 <input id="fdeliverUnit" name="fdeliverUnit" type="text" style="width: 800px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
