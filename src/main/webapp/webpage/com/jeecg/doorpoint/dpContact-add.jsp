...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" tiptype="1 " layout="table" action="doorPointController.do?doAdd1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="fcontactName" name="fcontactName" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fmobile" name="fmobile" type="text" style="width: 150px" class="inputxt" 		datatype="m" ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="femail" name="femail" type="text" style="width: 150px" class="inputxt" 		datatype="e" ignore="ignore" />
							<span class="Validform_checktip"></span>
