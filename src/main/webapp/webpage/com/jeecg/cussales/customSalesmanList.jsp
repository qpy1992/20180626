	...
	<%--<c:if test="${fn:length(customSalesmanList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="customSalesmanList[0].ftc" maxlength="32" type="text" class="inputxt"  style="width:120px;"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" >
		...
		<c:forEach items="${customSalesmanList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" /></td>
                   ...
                   <td align="left">
                        <input name="customSalesmanList[${stuts.index }].ftc" maxlength="32" type="text" class="inputxt"  style="width:100px;"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore"  value="${poVal.ftc }"/>
                        <label>%</label>
                   </td>
				   <td align="left">
					  	<input name="customSalesmanList[${stuts.index }].fnote" maxlength="255" type="text" class="inputxt"  style="width:220px;"  ignore="ignore"  value="${poVal.fnote }"/>
					  <label class="Validform_label" style="display: none;">备注</label>
				   </td>
   			</tr>
		</c:forEach>
