...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="truesfController.do?doAdd" >
	  <input id="id" name="id" type="hidden" value="${truesfPage.id }"/>
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<input id="fhxtime" type="text" style="width: 150px" class="inputxt"	readonly="readonly"  ignore="ignore" value="${fhxtime}"/>
					</td>
					<td align="right">
						<label class="Validform_label">
							核销人:
					...
					<td class="value">
						<input id="fhxman" type="text" style="width: 150px" class="inputxt"	readonly="readonly"  ignore="ignore" value="${fhxman}"/>
					</td>
				</tr>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fshoufu" name="fshoufu" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="fremain" name="fremain" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fsettletype" name="fsettletype" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="fbank" name="fbank" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fvoucher" name="fvoucher" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="fvoucherno" name="fvoucherno" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fvoumonth" name="fvoumonth" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fmonthno" name="fmonthno" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
