...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="zPcPayList" checkbox="false" pagination="true" fitColumns="true" title="" actionUrl="zPcPayController.do?datagrid&pid=${pid}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="代垫"  field="fdaidian"  queryMode="single"></t:dgCol>
   <t:dgCol title="报销"  field="fbaoxiao"  queryMode="single"></t:dgCol>
   <t:dgCol title="箱号"  field="fxianghao"  queryMode="single"></t:dgCol>
   <t:dgCol title="委托编号"  field="fweitup"  queryMode="single"></t:dgCol>
   ...
   <t:dgDelOpt title="删除" url="zPcPayController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="zPcPayController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="zPcPayController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="zPcPayController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="zPcPayController.do?goUpdate" funname="detail"></t:dgToolBar>
 ...
 <script src = "webpage/com/jeecg/pay/zPcPayList.js"></script>		
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'zPcPayController.do?upload', "zPcPayList");
}

//导出
function ExportXls() {
	JeecgExcelExport("zPcPayController.do?exportXls","zPcPayList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("zPcPayController.do?exportXlsByT","zPcPayList");
}
