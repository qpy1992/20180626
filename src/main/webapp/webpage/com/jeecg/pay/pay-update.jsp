...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="payController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="fbillno" name="fbillno" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${payPage.fbillno}'/>
			...
			<td class="value">
		     	 <input id="funitcode" name="funitcode" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${payPage.funitcode}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="fbibie" name="fbibie" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${payPage.fbibie}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="famount" name="famount" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore"  value='${payPage.famount}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
					  <input id="fstartdate" name="fstartdate" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${payPage.fstartdate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="fenddate" name="fenddate" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${payPage.fenddate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="frange" name="frange" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${payPage.frange}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="funit" name="funit" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${payPage.funit}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				 <textarea id="fnote" style="width:600px;" class="inputxt" rows="6" name="fnote"  ignore="ignore" >${payPage.fnote}</textarea>
				<span class="Validform_checktip"></span>
		...
		<tbody id="add_zhangdan_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  <td align="left">
					  		<input name="zhangdanList[#index#].fcheck" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
