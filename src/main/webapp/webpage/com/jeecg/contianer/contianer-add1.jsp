...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="contianerController.do?doAdd&fsettleid=${entrustPage.cid}&buss=1" beforeSubmit="GetCntr()">
	  <input id="id" name="id" type="hidden" value="${contianerPage.id }"/>
	  <input id="fid" name="fid" type="hidden" value="${cid }"/>
	<table cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            <label class="Validform_label" style="font-size: 20px;font-weight: bold;color: #D53F40">进口</label>
        </tr>
		<tr>
			<td align="right">
        ...
        <tr>
            ...
            <td class="value">
                ...
                <t:choose hiddenName="cid" hiddenid="" url="contianerController.do?list1" name="costCombinationList" icon="icon-search" textname="id,ftxyard,fdischarge,fxhdpdz,fxhcontact,fxhmobile,fhxyard,fcost"
                          inputTextname="cid1,fextract,fxhdp,fxhdpdz,fxhcontact,fxhmobile,freturn,fprice" isInit="true" isclear="true" width="800" height="300"></t:choose>
                <span class="Validform_checktip"></span>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            <td align="right">
                <label class="Validform_label">委托卸货件数:</label>
            </td>
            <td class="value">
                <input id="fwtxhnum" name="fwtxhnum" type="text" style="width: 150px"  datatype="/^(-?\d+)(\.\d+)?$/" class="inputxt"  ignore="ignore" />
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">委托卸货件数</label>
            </td>
            <td align="right">
                <label class="Validform_label">实际卸货件数:</label>
            </td>
            <td class="value" colspan="3">
                <input id="fxhnum" name="fxhnum" type="text" style="width: 150px"  datatype="/^(-?\d+)(\.\d+)?$/" class="inputxt"  ignore="ignore" />
                <span class="Validform_checktip"></span>
                <label class="Validform_label" style="display: none;">实际卸货件数</label>
            </td>
        </tr>
        <tr>
            <td align="right">
