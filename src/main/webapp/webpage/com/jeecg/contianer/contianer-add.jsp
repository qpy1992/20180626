...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="contianerController.do?doAdd&fsettleid=${entrustPage.cid}&buss=0" beforeSubmit="GetCntr()">
	  <input id="id" name="id" type="hidden" value="${contianerPage.id }"/>
	  <input id="fid" name="fid" type="hidden" value="${cid }"/>
	<table cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            <label class="Validform_label" style="font-size: 20px;font-weight: bold;color: #D53F40">出口</label>
        </tr>
		<tr>
			<td align="right">
        ...
        <tr>
            ...
            <td class="value">
                ...
                <input id="fprice" name="fprice" type="text" style="width: 150px;display: none" class="inputxt"  ignore="ignore" />
                <span class="Validform_checktip"></span>
		...
		<tr>
            ...
            <td class="value">
                <t:dictSelect field="fjixu" hasLabel="fasle" typeGroupCode="sf_yn" type="radio"></t:dictSelect>
            </td>--%>
            <td align="right">
			...
			<div style="width: auto;height: 200px;">
                ...
                <t:tab href="contianerController.do?detailList&id=${contianerPage.id}&fblno=${entrustPage.fblno}" icon="icon-search" title="箱货明细" id="detail"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
