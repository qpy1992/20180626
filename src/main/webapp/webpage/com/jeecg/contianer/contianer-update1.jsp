  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="contianerController.do?doUpdate" beforeSubmit="GetCntr()">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            ...
            <td class="value">
                <input id="fwtxhnum" name="fwtxhnum" type="text" style="width: 150px"  datatype="/^(-?\d+)(\.\d+)?$/" class="inputxt"  ignore="ignore" value="${contianerPage.fwtxhnum}"/>
                <span class="Validform_checktip"></span>
            ...
            <td class="value" colspan="3">
                <input id="fxhnum" name="fxhnum" type="text" style="width: 150px"  datatype="/^(-?\d+)(\.\d+)?$/" class="inputxt"  ignore="ignore" value="${contianerPage.fxhnum}"/>
                <span class="Validform_checktip"></span>
