	...
	<%--<c:if test="${fn:length(customContactsList)  <= 0 }">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  	<input name="customContactsList[0].fmobile" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" >
				  ...
				  <td align="left">
					  	<input name="customContactsList[0].femail" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" >
					  <label class="Validform_label" style="display: none;">EMAIL</label>
					</td>
				  <td align="left">
							<t:dictSelect field="customContactsList[0].finance" type="radio"   typeGroupCode="sf_yn"  defaultVal="${customContactsPage.finance}" hasLabel="false"  title="财务"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">财务</label>
					</td>
				  <td align="left">
							<t:dictSelect field="customContactsList[0].foperation" type="radio"   typeGroupCode="sf_yn"  defaultVal="${customContactsPage.foperation}" hasLabel="false"  title="操作"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">操作</label>
					</td>
				  <td align="left">
							<t:dictSelect field="customContactsList[0].business" type="radio"   typeGroupCode="sf_yn"  defaultVal="${customContactsPage.business}" hasLabel="false"  title="业务"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">业务</label>
					</td>
				  <td align="left">
							<t:dictSelect field="customContactsList[0].manager" type="radio"   typeGroupCode="sf_yn"  defaultVal="${customContactsPage.manager}" hasLabel="false"  title="经理"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">经理</label>
					</td>
				  <td align="left">
		...
		<c:forEach items="${customContactsList}" var="poVal" varStatus="stuts">
			<tr>
				...
				<td align="center"><input style="width:20px;"  type="checkbox" name="ck" /></td>
				   ...
				   <td align="left">
					  	<input name="customContactsList[${stuts.index }].fmobile" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore"  value="${poVal.fmobile }"/>
					  <label class="Validform_label" style="display: none;">手机</label>
				   </td>
				   <td align="left">
				   ...
				   <td align="left">
					  	<input name="customContactsList[${stuts.index }].femail" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore"  value="${poVal.femail }"/>
					  <label class="Validform_label" style="display: none;">EMAIL</label>
				   </td>
				   <td align="left">
							<t:dictSelect field="customContactsList[${stuts.index }].finance" type="radio"   typeGroupCode="sf_yn"  defaultVal="${poVal.finance }" hasLabel="false"  title="财务"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">财务</label>
				   </td>
				   <td align="left">
							<t:dictSelect field="customContactsList[${stuts.index }].foperation" type="radio"   typeGroupCode="sf_yn"  defaultVal="${poVal.foperation }" hasLabel="false"  title="操作"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">操作</label>
				   </td>
				   <td align="left">
							<t:dictSelect field="customContactsList[${stuts.index }].business" type="radio"   typeGroupCode="sf_yn"  defaultVal="${poVal.business }" hasLabel="false"  title="业务"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">业务</label>
				   </td>
				   <td align="left">
							<t:dictSelect field="customContactsList[${stuts.index }].manager" type="radio"   typeGroupCode="sf_yn"  defaultVal="${poVal.manager }" hasLabel="false"  title="经理"></t:dictSelect>     
					  <label class="Validform_label" style="display: none;">经理</label>
				   </td>
				   <td align="left">
					  	<input name="customContactsList[${stuts.index }].fnote" maxlength="255" type="text" class="inputxt"  style="width:300px;"  ignore="ignore"  value="${poVal.fnote }"/>
					  <label class="Validform_label" style="display: none;">备注</label>
				   </td>
   			</tr>
		</c:forEach>
