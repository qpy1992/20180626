...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="costList1" checkbox="false" pagination="true" fitColumns="true" title="费用列表"
 ...
 <script type="text/javascript">
    function addcost() {
        var row = $('#costList1').datagrid('getSelected');
        $.ajax({
            url : 'bxcostController.do?addcost&ids=${ids}',
            type : 'post',
            data : {
                cid : row.id,
            },
