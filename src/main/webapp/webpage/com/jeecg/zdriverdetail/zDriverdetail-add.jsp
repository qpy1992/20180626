...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zDriverdetailController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="jobnumber" name="jobnumber" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="entryDate" name="entryDate" type="text" style="width: 150px" class="Wdate"  onClick="WdatePicker()"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	<!--  <input id="sex" name="sex" type="list" typeGroupCode="sex" style="width: 150px" class="inputxt"  ignore="ignore" /> -->
							<t:dictSelect field="sex" type="list" typeGroupCode="sex" hasLabel="false" title="性别"></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="birthDate" name="birthDate" type="text" style="width: 150px"  class="Wdate"  onClick="WdatePicker()"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	<!--  <input id="education" name="education" type="text" style="width: 150px" class="inputxt"  ignore="ignore" /> -->
								<t:dictSelect field="education" type="list" typeGroupCode="xueli" hasLabel="false" title="学历" ></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="nation" name="nation" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="birthplace" name="birthplace" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="idcard" name="idcard" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="political" name="political" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="residentialAddress" name="residentialAddress" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<tr>
						...
						<td class="value">
							...
							<t:dictSelect field="ishu" type="list" typeGroupCode="hutype" hasLabel="false" title="是否沪籍" ></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="registrationAddress" name="registrationAddress" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="licenseNo" name="licenseNo" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="issuingAuthority" name="issuingAuthority" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     <!-- 	 <input id="image" name="image" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							...
							<label class="Validform_label" style="display: none;">照片</label> -->
								<t:webUploader name="image" auto="true"  type="image" fileNumLimit="1"></t:webUploader>
