...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="currencyController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="fcurrencyid" name="fcurrencyid" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
					...
					<td class="value">
							<t:dictSelect field="fyouxiao"  typeGroupCode="sf_yn"  hasLabel="false"></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" colspan="3">
						<t:dictSelect field="fbenwei"  typeGroupCode="sf_yn"  hasLabel="false"></t:dictSelect>
						<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fsymbol" name="fsymbol" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
