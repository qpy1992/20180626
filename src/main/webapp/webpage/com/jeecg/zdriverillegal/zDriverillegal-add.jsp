...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="zDriverillegalController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="driverName" name="driverName" placeholder="点击选择" type="text" style="width: 150px" class="inputxt" onclick="popupClick(this,'id,fname,license_no','driverId,driverName,cardNo','drivers')" ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					  ...
					  <input id="driverId"  hidden="hidden"  name="driverId"      ignore="ignore" />
			</table>
