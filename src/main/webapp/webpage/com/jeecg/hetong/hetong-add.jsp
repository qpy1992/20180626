...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="hetongController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				...
				<input id="fsettle" name="fsettle" placeholder="点击选择" onclick="popupClick(this, 'fcustom_code,fcn_name', 'fsettle,fsettleName', 'weituo');" type="text" style="width: 150px" class="inputxt" ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr hidden="hidden">
			...
			<td class="value" colspan="3">
				...
				<input id="fbrno" name="fbrno" type="text" style="width: 150px" class="inputxt" ignore="ignore" />
				<span class="Validform_checktip"></span>
