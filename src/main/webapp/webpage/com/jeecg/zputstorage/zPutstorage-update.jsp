...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zPutstorageController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="code" name="code" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zPutstoragePage.code}'/>
			...
			<td class="value">
		     	 <input id="makeDate" name="makeDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  ignore="ignore"  value='${zPutstoragePage.makeDate}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="makePeople" name="makePeople" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zPutstoragePage.makePeople}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="checkPeople" name="checkPeople" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zPutstoragePage.checkPeople}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="checkDate" name="checkDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()" ignore="ignore"  value='${zPutstoragePage.checkDate}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="note" name="note" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zPutstoragePage.note}'/>
				<span class="Validform_checktip"></span>
			...
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
			  <td align="left">
				  ...
				  <td align="left">
					  		<input name="zPutstorageDetailList[#index#].unit" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">单位</label>
				  </td>
				  <td align="left">
					  		<input name="zPutstorageDetailList[#index#].rkNumber" maxlength="32" type="text" class="inputxt"  style="width:120px;"  datatype="n"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">入库数量</label>
				  </td>
				  <td align="left">
					  		<input name="zPutstorageDetailList[#index#].purchasePrice" maxlength="32" type="text" class="inputxt"  style="width:120px;"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">进价</label>
				  </td>
				  <td align="left">
					  		<input name="zPutstorageDetailList[#index#].purchaseTotal" maxlength="32" type="text" class="inputxt"  style="width:120px;"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">进价合计</label>
				  </td>
				  <td align="left">
					  		<input name="zPutstorageDetailList[#index#].salePrice" maxlength="32" type="text" class="inputxt"  style="width:120px;"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">售价</label>
				  </td>
				  <td align="left">
					  		<input name="zPutstorageDetailList[#index#].saleTotal" maxlength="32" type="text" class="inputxt"  style="width:120px;"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
