...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="feeController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="feeCode" name="feeCode" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feePage.feeCode}'/>
						...
						<td class="value">
							<t:dictSelect field="fvoid" type="radio"  typeGroupCode="sf_yn"   defaultVal="${feePage.fvoid}" hasLabel="false"  title="作废" ></t:dictSelect>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="fcnName" name="fcnName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feePage.fcnName}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="fname" name="fname" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feePage.fname}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="fdefaultCurrency" name="fdefaultCurrency" onclick="popupClick(this,'fname','fdefaultCurrency','currency');" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${feePage.fdefaultCurrency}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="fdefaultPrice" name="fdefaultPrice" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore"  value='${feePage.fdefaultPrice}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="fcontractPrice" name="fcontractPrice" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore"  value='${feePage.fcontractPrice}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value"  colspan="3" >
							<textarea id="finstruction" style="width:550px;height: 80px;" class="inputxt" rows="6" name="finstruction"  ignore="ignore" >${feePage.finstruction}</textarea>
							<span class="Validform_checktip"></span>
