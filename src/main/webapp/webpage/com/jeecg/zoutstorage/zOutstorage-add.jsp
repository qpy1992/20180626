...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zOutstorageController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="checkDate" name="checkDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()" ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="carcode" name="carcode" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="driver" name="driver" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="lyperson" name="lyperson" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="lytotal" name="lytotal" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
 ...
 <script src = "webpage/com/jeecg/zoutstorage/zOutstorage.js"></script>
  ...
  <script type="text/javascript">
		 ...
		 function fun_tel(ele){
		alert("11111")
			 var a=ele.cells[6].childNodes[0].value;   
			 alert(a);
