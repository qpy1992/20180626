...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="costCombinationList" checkbox="false" pagination="true" fitColumns="true" title="费用组合" actionUrl="customController.do?datagrid1&fid=${fid}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="含税费用"  field="fhscost"  queryMode="single"  width="100"></t:dgCol>
