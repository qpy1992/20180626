...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="customController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
            ...
            <td class="value" colspan="3">
                <input id="fcustomCode" name="fcustomCode" type="text" style="width: 150px;display: none" class="inputxt"  ignore="ignore"  value='${customPage.fcustomCode}'/>
                <label class="Validform_label" style="font-size: 16px;font-weight: bold;color: #0a82eb">${customPage.fcustomCode}</label>
            </td>
        </tr>
        <tr>
			<td align="right">
			...
			<td class="value">
		     	 <input id="fabbr" name="fabbr" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fabbr}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fdutyPara" name="fdutyPara" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fdutyPara}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fcnName" name="fcnName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fcnName}'/>
				<span class="Validform_checktip"></span>
            ...
            <td class="value">
                <input id="fenName" name="fenName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fenName}'/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
			...
			<td class="value">
		     	 <input id="financeCode" name="financeCode" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.financeCode}'/>
				<span class="Validform_checktip"></span>
            ...
            <td class="value">
                <input type="text" id="province" style="width:80px;" value="${customPage.province}"/>
                <input type="text" id="city" style="width:80px;" value="${customPage.city}"/>
                <input type="text" id="area" style="width:80px;" value="${customPage.area}"/>
                <span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
                <input id="fcontractStart" name="fcontractStart" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"   ignore="ignore"  value='<fmt:formatDate value='${customPage.fcontractStart}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip">~</span>
                <input id="fcontractEnd" name="fcontractEnd" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"   ignore="ignore"  value='<fmt:formatDate value='${customPage.fcontractEnd}' type="date" pattern="yyyy-MM-dd"/>'/>
			</td>
			<td align="right">
				<label class="Validform_label">地址:</label>
			</td>
			<td class="value">
		     	 <input id="faddress" name="faddress" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.faddress}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fzipcode" name="fzipcode" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fzipcode}'/>
				<span class="Validform_checktip"></span>
        ...
        <tr>
			...
			<td class="value">
		     	 <input id="fmobile" name="fmobile" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fmobile}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fax" name="fax" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fax}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fkeyword" name="fkeyword" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fkeyword}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fcompanyWebsite" name="fcompanyWebsite" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fcompanyWebsite}'/>
				<span class="Validform_checktip"></span>
        ...
        <tr>
			...
			<td class="value">
		     	 <input id="femail" name="femail" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.femail}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fticketRate" name="fticketRate"  datatype="/^(-?\d+)(\.\d+)?$/" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${customPage.fticketRate}'/>
				<span>%</span>
			...
			<td class="value" colspan="3">
                <textarea id="finstruction" style="width:600px;" class="inputxt" rows="6" name="finstruction"  ignore="ignore">${customPage.finstruction}</textarea>
				<span class="Validform_checktip"></span>
		...
		<tbody id="add_customContacts_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
                      <t:dictSelect field="customContactsList[#index#].fgender" hasLabel="false" typeGroupCode="sex"></t:dictSelect>
				  ...
				  <td align="left">
                      <input name="customContactsList[#index#].fnote" maxlength="255" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
		...
		<tbody id="add_customSalesman_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  		<input name="customSalesmanList[#index#].fnote" maxlength="255" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
					  <label class="Validform_label" style="display: none;">备注</label>
				  </td>
				  <td align="left">
			...
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
                <td align="left">
                    ...
                    <input name="costCombinationList[#index#].ftxid" hidden="hidden" maxlength="32" type="text" class="inputxt"  style="width:120px;display: none"  ignore="ignore" />
                ...
                &lt;%&ndash;<td align="left">
                    ...
                    <input name="costCombinationList[#index#].fimportid" hidden="hidden" maxlength="32" type="text" class="inputxt"  style="width:120px;display: none"  ignore="ignore" />
                ...
                <td align="left">
                    ...
                    <input name="costCombinationList[#index#].floadid" hidden="hidden" maxlength="32" type="text" class="inputxt"  style="width:120px;display: none"  ignore="ignore" />
                ...
                <td align="left">
                    ...
                    <input name="costCombinationList[#index#].fdischargeid" hidden="hidden" maxlength="32" type="text" class="inputxt"  style="width:120px;display: none"  ignore="ignore" />
                ...
                &lt;%&ndash;<td align="left">
                    ...
                    <input name="costCombinationList[#index#].fexportid" hidden="hidden" maxlength="32" type="text" class="inputxt"  style="width:120px;display: none"  ignore="ignore" />
                ...
                <td align="left">
                    ...
                    <input name="costCombinationList[#index#].fhxid" hidden="hidden" maxlength="32" type="text" class="inputxt"  style="width:120px;display: none"  ignore="ignore" />
                ...
                <td align="left">
                    <input name="costCombinationList[#index#].fstart" maxlength="32" type="text"  class="Wdate" onClick="WdatePicker()"  style="width:120px;" />
                    <label class="Validform_label" style="display: none;">开始时间</label>
                </td>
                <td align="left">
                    <input name="costCombinationList[#index#].fnote" maxlength="255" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
                    <label class="Validform_label" style="display: none;">备注</label>
                </td>
			</tr>
		 </tbody>--%>
