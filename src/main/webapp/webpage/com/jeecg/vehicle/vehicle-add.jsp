...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="vehicleController.do?doAdd" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 800px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fengin" name="fengin" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="fengintype" name="fengintype" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fdisplace" name="fdisplace" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fwatt" name="fwatt" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
            ...
            <tr>
					...
					<td class="value">
                        <input id="flunju1" name="flunju1" type="text" style="width: 75px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
                        <input id="flunju2" name="flunju2" type="text" style="width: 75px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="faxis" name="faxis" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
							<span class="Validform_checktip" style="color: #000000">mm</span>
					...
					<td class="value">
					     	 <input id="faxisnum" name="faxisnum" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
                        <input id="flength" name="flength" placeholder="长" type="text" style="width: 50px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
                        <input id="fwidth" name="fwidth" placeholder="宽" type="text" style="width: 50px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
                        <input id="fheight" name="fheight" placeholder="高" type="text" style="width: 50px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
                        <span class="Validform_checktip" style="color: #000000">mm</span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="fnature" name="fnature" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
                        ...
                        <input id="flognum" name="flognum" type="text" style="width: 80px" class="inputxt"  ignore="ignore" />
                        <span class="Validform_checktip" style="color: #000000">号</span>
                        <label class="Validform_label" style="display: none;">运输证号</label>
                    </td>
                </tr>
				<tr>
					<td align="right">
