...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="chargeList1" checkbox="true" pagination="true" fitColumns="true" title="应收(要求客户书面确认)" actionUrl="chargeController.do?datagrid1&pid=${pid}&sf=0" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="费用种类"  field="fcost"  queryMode="single"></t:dgCol>
   <t:dgCol title="费用种类名称"  field="fcostname"  queryMode="single"></t:dgCol>
   ...
   <t:dgCol title="币别"  field="fbibie"  queryMode="single"></t:dgCol>
   <t:dgCol title="汇率"  field="fhuilv"  queryMode="single"></t:dgCol>
   <t:dgCol title="数量"  field="fqty"  queryMode="single"></t:dgCol>
   <t:dgCol title="金额"  field="famount"  queryMode="single"></t:dgCol>
   <t:dgCol title="收付金额"  field="fsfamount"  queryMode="single"></t:dgCol>
   <t:dgCol title="本位币金额"  field="fbwamount"  queryMode="single"></t:dgCol>
   <t:dgCol title="代垫"  field="fdd" dictionary="sf_yn"  queryMode="single"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="chargeController.do?goAdd1&cid=${pid}&ly=1&sf=0" funname="add"></t:dgToolBar>
