...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="chargeList3" checkbox="true" pagination="true" fitColumns="true" title="费用" actionUrl="chargeController.do?datagrid3&idlist=${idlist}" idField="id" fit="true" queryMode="group">
