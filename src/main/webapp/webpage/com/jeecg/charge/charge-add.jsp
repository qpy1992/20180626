  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" tiptype="1" layout="table" action="chargeController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<t:dictSelect id="fshoufu" field="fshoufu"  typeGroupCode="shoufu"  defaultVal="${chargePage.fshoufu}" hasLabel="false"></t:dictSelect>
					</td>
					<td align="right">
						<label class="Validform_label">
							费用种类:
					...
					<td class="value">
						<input id="fcost" name="fcost" placeholder="点击选择" onclick="popupClick(this,'fee_code,fname,fdefault_price','fcost,fcostname,fprice','costtype')" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					...
					<td class="value">
						<input id="fsfamount" name="fsfamount" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" value="0"/>
					</td>
					<td align="right">
						<label class="Validform_label">
							代垫:
				...
				<tr hidden="hidden">
					<td class="value">
						...
						<input id="conid" name="conid" type="text" style="width: 150px" class="inputxt"  ignore="ignore" value="${conid}"/>
