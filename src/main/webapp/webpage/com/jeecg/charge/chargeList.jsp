...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="chargeList" checkbox="true" pagination="true" fitColumns="true" title="费用" actionUrl="chargeController.do?datagrid&cid=${cid}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="收付"  field="fshoufu"  queryMode="single"  dictionary="shoufu"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="chargeController.do?goAdd&cid=${cid}&ly=0" funname="add"></t:dgToolBar>
