...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="chargeList" checkbox="true" pagination="true" fitColumns="true" title="应付" actionUrl="chargeController.do?datagrid1&pid=${pid}&sf=1" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="chargeController.do?goAdd1&cid=${pid}&ly=1&sf=1" funname="add"></t:dgToolBar>
