...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="zExitController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="zLsbm" name="zLsbm" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zExitPage.zLsbm}'/>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="zZdpeople" name="zZdpeople" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zExitPage.zZdpeople}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="zCheckpeople" name="zCheckpeople" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zExitPage.zCheckpeople}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="zCh" name="zCh" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zExitPage.zCh}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="zJsy" name="zJsy" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zExitPage.zJsy}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="zExitpeople" name="zExitpeople" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zExitPage.zExitpeople}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="zExittotal" name="zExittotal" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zExitPage.zExittotal}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="zBz" name="zBz" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${zExitPage.zBz}'/>
				<span class="Validform_checktip"></span>
		...
		<tbody id="add_zExitdetail_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
					  		<input name="zExitdetailList[#index#].zWldm" maxlength="32" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
