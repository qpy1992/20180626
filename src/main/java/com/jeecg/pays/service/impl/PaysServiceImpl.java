package com.jeecg.pays.service.impl;
...
@Service("paysService")
@Transactional
public class PaysServiceImpl extends CommonServiceImpl implements PaysServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(PaysEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(PaysEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(PaysEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(PaysEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,PaysEntity t){
