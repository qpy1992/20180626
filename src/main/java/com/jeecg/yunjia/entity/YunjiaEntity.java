package com.jeecg.yunjia.entity;
 ...
 */
@Entity
@Table(name = "z_yunjia", schema = "")
@SuppressWarnings("serial")
public class YunjiaEntity implements java.io.Serializable {
	/**主键*/
	...
	/**确认单号*/
	@Excel(name="确认单号",width=15)
	private java.lang.String fbillno;
	/**状态*/
	@Excel(name="状态",width=15)
	private java.lang.String fstatus;
	/**确认人*/
	private java.lang.String fconfirmName;
	/**确认时间*/
	private java.util.Date fconfirmTime;
	/**备注*/
	...
	@Column(name ="FCONFIRM_NAME",nullable=true,length=32)
	public java.lang.String getFconfirmName(){
		return this.fconfirmName;
	}
	 ...
	 */
	public void setFconfirmName(java.lang.String fconfirmName){
		this.fconfirmName = fconfirmName;
	}
	/**
	 *方法: 取得java.util.Date
	...
	@Column(name ="FCONFIRM_TIME",nullable=true,length=32)
	public java.util.Date getFconfirmTime(){
	 ...
	 */
	public void setFconfirmTime(java.util.Date fconfirmTime){
