package com.jeecg.yunjia.service.impl;
...
@Service("yunjiaService")
@Transactional
public class YunjiaServiceImpl extends CommonServiceImpl implements YunjiaServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(YunjiaEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(YunjiaEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(YunjiaEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(YunjiaEntity t){
		...
		map.put("fconfirm_name", t.getFconfirmName());
		map.put("fconfirm_time", t.getFconfirmTime());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,YunjiaEntity t){
 		...
 		sql  = sql.replace("#{fconfirm_name}",String.valueOf(t.getFconfirmName()));
 		sql  = sql.replace("#{fconfirm_time}",String.valueOf(t.getFconfirmTime()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("z_yunjia",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
