...
*/
	...
	@Arguments("wulioName")
	@Sql("select count(*) from z_store where fname=:wulioName")
	Integer getStore(String wulioName);
	
	@Arguments("wulioName")
	@Sql("select rk_number from z_store where fname=:wulioName")
	Integer getStorenumber(String wulioName);
	
	@Arguments({"fid","wulioName"})
	@Sql("select rk_number from z_putstorage_detail where fid=:fid and wulio_name=:wulioName")
	Integer getPutstorage(String fid,String wulioName);
	
	@Arguments({"fid","wulioName"})
	@Sql("select ly_number from z_outstoragedetail where fid=:fid and wulio_name=:wulioName")
	Integer getOutstorage(String fid,String wulioName);
	
/*	@Arguments("fid")
	@Sql("select rk_number from z_putstorage_detail where id=:id")
	Integer getPutstorage(String id);*/
}
