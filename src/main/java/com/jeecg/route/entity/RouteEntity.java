package com.jeecg.route.entity;
 ...
 */
@Entity
@Table(name = "z_route", schema = "")
@SuppressWarnings("serial")
public class RouteEntity implements java.io.Serializable {
	/**主键*/
