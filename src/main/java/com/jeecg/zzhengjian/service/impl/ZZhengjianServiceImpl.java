package com.jeecg.zzhengjian.service.impl;
...
@Service("zZhengjianService")
@Transactional
public class ZZhengjianServiceImpl extends CommonServiceImpl implements ZZhengjianServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ZZhengjianEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(ZZhengjianEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(ZZhengjianEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(ZZhengjianEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("fname", t.getFname());
		map.put("zhengjian_no", t.getZhengjianNo());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ZZhengjianEntity t){
 		sql  = sql.replace("#{id}",String.valueOf(t.getId()));
 		sql  = sql.replace("#{fname}",String.valueOf(t.getFname()));
 		sql  = sql.replace("#{zhengjian_no}",String.valueOf(t.getZhengjianNo()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("z_zhengjian",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
