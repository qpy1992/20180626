package com.jeecg.z_exitdetail.entity;
 ...
 * @date 2018-08-10 12:21:39
 * @version V1.0   
 *
 */
@Entity
@Table(name = "z_exitdetail", schema = "")
@SuppressWarnings("serial")
public class ZExitdetailEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.String zExitId;
	/**物料代码*/
	...
	private java.lang.String zKcsl;
	/**出库数量*/
    @Excel(name="出库数量",width=15)
	private java.lang.String zExitnum;
	/**进价*/
	...
	private java.lang.Double zProfit;
	/**备注*/
	...
	@Column(name ="Z_EXIT_ID",nullable=true,length=32)
	public java.lang.String getZExitId(){
		return this.zExitId;
	}
	 ...
	 */
	public void setZExitId(java.lang.String zExitId){
		this.zExitId = zExitId;
	}
	...
	@Column(name ="Z_KCSL",nullable=true,length=32)
	public java.lang.String getZKcsl(){
		return this.zKcsl;
	}
	 ...
	 */
	public void setZKcsl(java.lang.String zKcsl){
		this.zKcsl = zKcsl;
	}
	...
	@Column(name ="Z_EXITNUM",nullable=true,length=32)
	public java.lang.String getZExitnum(){
		return this.zExitnum;
	}
	 ...
	 */
	public void setZExitnum(java.lang.String zExitnum){
		this.zExitnum = zExitnum;
	}
	...
	/**
	 *方法: 取得java.lang.Double
	 *@return: java.lang.Double  利润
	 */
	
	@Column(name ="Z_PROFIT",nullable=true,length=32)
	public java.lang.Double getZProfit(){
		return this.zProfit;
	}

	/**
	 *方法: 设置java.lang.Double
	 *@param: java.lang.Double  利润
	 */
	public void setZProfit(java.lang.Double zProfit){
