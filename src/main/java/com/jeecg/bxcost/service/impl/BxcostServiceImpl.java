package com.jeecg.bxcost.service.impl;
...
@Service("bxcostService")
@Transactional
public class BxcostServiceImpl extends CommonServiceImpl implements BxcostServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BxcostEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BxcostEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BxcostEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BxcostEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BxcostEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("z_bxcost",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
