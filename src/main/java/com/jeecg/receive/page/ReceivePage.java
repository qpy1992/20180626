...
package com.jeecg.receive.page;
 ...
 *
 */
public class ReceivePage implements java.io.Serializable {
	/**主键*/
	...
	/**保存-应收账单明细*/
    @ExcelCollection(name="应收账单明细")
	private List<Zhangdan1Entity> zhangdan1List = new ArrayList<Zhangdan1Entity>();
		public List<Zhangdan1Entity> getZhangdan1List() {
		return zhangdan1List;
		}
		public void setZhangdan1List(List<Zhangdan1Entity> zhangdan1List) {
		this.zhangdan1List = zhangdan1List;
		}
}
