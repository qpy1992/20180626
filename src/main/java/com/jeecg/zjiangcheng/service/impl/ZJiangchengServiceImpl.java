package com.jeecg.zjiangcheng.service.impl;
...
@Service("zJiangchengService")
@Transactional
public class ZJiangchengServiceImpl extends CommonServiceImpl implements ZJiangchengServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ZJiangchengEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(ZJiangchengEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(ZJiangchengEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(ZJiangchengEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("create_date", t.getCreateDate());
		map.put("time", t.getTime());
		map.put("reason", t.getReason());
		map.put("record", t.getRecord());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ZJiangchengEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("z_jiangcheng",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
