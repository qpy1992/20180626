package com.jeecg.baoxiao.entity;
 ...
 */
@Entity
@Table(name = "z_baoxiao", schema = "")
@SuppressWarnings("serial")
public class BaoxiaoEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="FBXNO",nullable=true,length=32)
	...
	@Column(name ="FAPPLYER",nullable=true,length=32)
	...
	@Column(name ="FAPPLYDATE",nullable=true,length=32)
	...
	@Column(name ="FCHECKDATE",nullable=true,length=32)
	...
	@Column(name ="FHXSTATUS",nullable=true,length=32)
	...
	@Column(name ="FBXMAN",nullable=true,length=32)
	...
	@Column(name ="FPCNO",nullable=true,length=32)
