package com.jeecg.rece.service.impl;
...
@Service("receService")
@Transactional
public class ReceServiceImpl extends CommonServiceImpl implements ReceServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ReceEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(ReceEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(ReceEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(ReceEntity t){
		...
		map.put("funitcode", t.getFunitcode());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ReceEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("z_receive",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
