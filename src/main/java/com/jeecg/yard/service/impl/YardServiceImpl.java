...
public class YardServiceImpl extends CommonServiceImpl implements YardServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(YardEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(YardEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(YardEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(YardEntity t){
		...
		map.put("fyard_code", t.getFyardCode());
		map.put("fyard_name", t.getFyardName());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,YardEntity t){
 		...
 		sql  = sql.replace("#{fyard_code}",String.valueOf(t.getFyardCode()));
 		sql  = sql.replace("#{fyard_name}",String.valueOf(t.getFyardName()));
