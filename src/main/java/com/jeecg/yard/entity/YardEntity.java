...
public class YardEntity implements java.io.Serializable {
	...
	@Column(name ="FYARD_CODE",nullable=true,length=32)
	...
	@Column(name ="FYARD_NAME",nullable=true,length=32)
	...
	@Column(name="fcontact",nullable=true)
	...
	@Column(name="fphone",nullable=true)
