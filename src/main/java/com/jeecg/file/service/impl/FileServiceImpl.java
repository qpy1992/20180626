package com.jeecg.file.service.impl;
...
public class FileServiceImpl extends CommonServiceImpl implements FileServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(FileEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(FileEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(FileEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(FileEntity t){
		...
		map.put("ffujian", t.getFfujian());
		map.put("fchicun", t.getFchicun());
		map.put("fyuan", t.getFyuan());
	 ...
	 */
 	public String replaceVal(String sql,FileEntity t){
 		...
 		sql  = sql.replace("#{ffujian}",String.valueOf(t.getFfujian()));
 		sql  = sql.replace("#{fchicun}",String.valueOf(t.getFchicun()));
 		sql  = sql.replace("#{fyuan}",String.valueOf(t.getFyuan()));
