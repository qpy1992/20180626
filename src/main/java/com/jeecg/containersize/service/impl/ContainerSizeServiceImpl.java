package com.jeecg.containersize.service.impl;
...
@Service("containerSizeService")
@Transactional
public class ContainerSizeServiceImpl extends CommonServiceImpl implements ContainerSizeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ContainerSizeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(ContainerSizeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(ContainerSizeEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(ContainerSizeEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ContainerSizeEntity t){
 		...
 		sql  = sql.replace("#{fvolum}",String.valueOf(t.getFvolum()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("z_container_size",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
